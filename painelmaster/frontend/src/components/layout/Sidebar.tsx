...
const serverItems: NavItem[] = [
  ...
  { path: '/core?tab=lines&view=manage', label: 'Clientes', icon: Icons.customers, key: 'core', roles: ['SUPER_ADMIN', 'ADMIN', 'MASTER_RESELLER', 'RESELLER'] },
  { path: '/core?tab=lines&view=tools', label: 'Clientes (Ferramentas)', icon: Icons.customers, key: 'core', roles: ['SUPER_ADMIN', 'ADMIN', 'MASTER_RESELLER', 'RESELLER'] },
